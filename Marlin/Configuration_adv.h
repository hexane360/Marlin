...
#define CONTROLLERFAN_PIN FAN1_PIN //Pin used for the fan to cool controller (-1 to disable)
#define CONTROLLERFAN_SECS 60 //How many seconds, after all motors were disabled, the fan should run
#define CONTROLLERFAN_SPEED 30410  // == full speed
...
#define FWRETRACT  //ONLY PARTIALLY TESTED
  ...
  #define MIN_RETRACT 2                  //minimum extruded mm to accept a automatic gcode retraction attempt
  ...
  #define RETRACT_FEEDRATE 10            //default feedrate for retracting (mm/s)
  #define RETRACT_ZLIFT 0.2              //default retract Z-lift
  #define RETRACT_RECOVER_LENGTH 0       //default additional recover length (mm, added to retract length when recovering)
  #define RETRACT_RECOVER_LENGTH_SWAP 8  //default additional swap recover length (mm, added to retract length when recovering from extruder change)
