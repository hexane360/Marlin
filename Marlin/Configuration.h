...
#define STRING_CONFIG_H_AUTHOR "(colin@gilgenbach.net)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.5, 100.5, 1600, 833 } //independent of microstepping
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (-21)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT (256)    // Y point for Z homing when homing all axis (G28).
#endif
